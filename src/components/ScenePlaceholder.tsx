...
import { HistoricalScene } from '../app/api/generate-story/route';
...
export default function ScenePlaceholder({ 
  ...
  return (
    <section id="scene-viewer" className="w-full max-w-6xl mx-auto px-4 pb-20 relative z-10">
      ...
      <div className="relative rounded-3xl p-1 bg-gradient-to-b from-[#D4AF37]/40 via-[#242434] to-[#14141C] shadow-2xl">
        <div className="rounded-[22px] bg-[#0D0D11] p-4 sm:p-6 md:p-8 min-h-[500px] flex flex-col justify-between relative overflow-hidden">
            ...
            {scenes.length > 0 && (
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#161622] border border-[#D4AF37]/40 text-[11px] font-medium text-[#FFF3C4] shadow-gold-glow">
                  ...
                  <span>5-Scene Historical Journey Active</span>
                </span>
              </div>
            )}
          </div>
          ...
          <div className="my-6 relative z-10 flex-1 flex flex-col justify-center">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full mb-6">
                  ...
                  <div className="glass-panel p-3.5 rounded-xl text-left border border-[#242434]">
                    ...
                    <p className="text-[11px] text-[#64748B] mt-0.5">Soundscape cues</p>
                  </div>
                  <div className="glass-panel p-3.5 rounded-xl text-left border border-[#242434]">
            ...
            {!isLoading && scenes.length > 0 && currentScene && (
              ...
              >
                ...
                {/* 5-Scene Navigation Stepper Tabs */}
                <div className="flex items-center justify-between gap-1 sm:gap-2 overflow-x-auto pb-2 border-b border-[#242434]">
                  {scenes.map((sc, idx) => {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="lg:col-span-6 relative group rounded-2xl overflow-hidden border border-[#D4AF37]/30 shadow-2xl aspect-video bg-[#14141C]">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 p-3 rounded-xl bg-[#0D0D11]/90 backdrop-blur-xl border border-[#D4AF37]/30 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => setIsPlayingAudio(!isPlayingAudio)}
                          className="w-8 h-8 rounded-full bg-[#D4AF37] text-[#0D0D11] flex items-center justify-center hover:scale-105 transition-transform shadow-gold-glow"
                        >
                          {isPlayingAudio ? <Pause className="w-4 h-4 fill-current" /> : <Play className="w-4 h-4 fill-current ml-0.5" />}
                        </button>
                        <div className="flex flex-col">
                          <span className="text-xs font-bold text-[#F8FAFC]">Ambient: #{currentScene.ambientTag}</span>
                          <span className="text-[10px] text-[#D4AF37] flex items-center gap-1">
                            <Radio className="w-3 h-3 animate-pulse" />
                            <span>Spatial Ambient Soundscape</span>
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="lg:col-span-6 flex flex-col justify-between h-full space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#D4AF37] text-[#0D0D11] font-bold text-xs hover:bg-[#FFF3C4] transition-all shadow-gold-glow"
                      >
                        <MessageCircle className="w-4 h-4" />
                        <span>Talk to Witness</span>
                      </button>
          ...
          <div className="pt-4 border-t border-[#242434] flex flex-wrap items-center justify-between gap-3 text-xs text-[#64748B] relative z-10">
            <div className="flex items-center gap-4">
              <span className="flex items-center gap-1">
                ...
                <span>Gemini API Strict JSON Pipeline Active</span>
              </span>
            </div>
            <div className="flex items-center gap-3">
              <span>TimeWitness Engine v1.4</span>
            </div>
          </div>
