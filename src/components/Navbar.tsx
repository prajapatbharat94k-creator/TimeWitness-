...
import { Hourglass, Globe, MessageSquare, ChevronDown, Sparkles, Compass, ScrollText } from 'lucide-react';
...
export default function Navbar({ currentLang, onLanguageChange, onOpenTalkToHistory }: NavbarProps) {
    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-[#0D0D11]/80 border-b border-[#242434]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-3 group focus:outline-none">
          <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#D4AF37]/20 to-[#14141C] border border-[#D4AF37]/40 shadow-gold-glow group-hover:border-[#D4AF37] transition-all duration-300">
            <Hourglass className="w-5 h-5 text-[#D4AF37] animate-pulse-slow group-hover:rotate-180 transition-transform duration-700" />
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] tracking-widest text-[#64748B] uppercase font-sans font-medium">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          <a href="#hero" className="text-[#94A3B8] hover:text-[#F8FAFC] flex items-center gap-2 transition-colors">
            <Compass className="w-4 h-4 text-[#D4AF37]" />
            <span>{currentLang === 'EN' ? 'Explore Eras' : 'युग खोजें'}</span>
          </a>
          <a href="#scene-viewer" className="text-[#94A3B8] hover:text-[#F8FAFC] flex items-center gap-2 transition-colors">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <motion.button
            ...
            className="relative group flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-gradient-to-r from-[#1E1B10] to-[#14141C] border border-[#D4AF37]/50 text-xs sm:text-sm font-semibold text-[#FFF3C4] shadow-gold-glow hover:border-[#D4AF37] hover:shadow-gold-glow-lg transition-all"
          >
            ...
            <span>{currentLang === 'EN' ? 'Talk to History' : 'इतिहास से बात करें'}</span>
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#14141C] border border-[#242434] hover:border-[#D4AF37]/40 text-xs sm:text-sm text-[#CBD5E1] transition-all"
            >
